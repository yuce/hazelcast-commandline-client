...
import (
	...
	"github.com/hazelcast/hazelcast-commandline-client/prv/cluster"
	...
	"github.com/hazelcast/hazelcast-commandline-client/prv/proto/codec/control"
)
...
func (j Jet) SubmitJob(ctx context.Context, path, jobName, className, snapshot string, args []string, br BinaryReader) error {
	...
	workaround := prv.CheckVersion(sv, "=", "5.3.0")
